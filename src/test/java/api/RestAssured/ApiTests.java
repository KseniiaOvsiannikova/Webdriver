    ...
    public void getDeserializedProduct(){
        ...
        Product actualProduct =
                ...
                when().
                    get(endpoint).
                        as(Product.class);
//        logger.info(String.format("Actual Deserialized Product is %s", actualProduct));
//        Assertions.assertEquals(actualProduct,expectedProduct, "Deserialized product does not much the expected product.");
